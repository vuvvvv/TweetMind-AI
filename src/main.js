      ...
      >
        <div className="max-w-4xl mx-auto relative">
          <textarea
            ...
            rows={1}
            className="w-full bg-gray-900 border border-gray-800 rounded-2xl px-4 py-2.5 pr-12 text-white placeholder-gray-500 focus:outline-none resize-none overflow-hidden transition-all"
          />
          <button
